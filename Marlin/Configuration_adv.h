...
//#define BEEP_ON_FEEDRATE_CHANGE
  ...
  #define POWER_LOSS_RECOVERY
    ...
    #define POWER_LOSS_PIN         -1 // Pin to detect power loss. Set to -1 to disable default pin on boards without module. Default: 44
    #define POWER_LOSS_STATE     HIGH // State of pin indicating power loss - Default: HIGH
